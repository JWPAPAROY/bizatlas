...
export const AXES = {
  capital_intensity: {
    label: '자본 집약도',
    tone: 'warn',
    hint: '1=노트북 한 대 / 5=공장 또는 인가 자본금',
    what: '이 모델을 **처음 시작하는 데** 드는 자본의 크기입니다. 지금 그 회사의 자산 규모가 아니라, 같은 사업을 새로 시작한다면 얼마가 필요한가로 봅니다. 설비·재고뿐 아니라 인허가에 걸린 최소 자본금·보증금도 함께 셉니다 — 결과물이 앱 하나여도 은행업이면 자본이 많이 듭니다.',
    levels: {
      1: '노트북 한 대 (SaaS·앱)',
      2: '소규모 클라우드 비용',
      3: '상당한 GPU·초기 재고·콘텐츠 선투자',
      4: '하드웨어 양산·물류 거점, 또는 인허가 자본금 (결제·대부)',
      5: '공장·중장비, 또는 대규모 인가 자본금 (은행·증권·보험)',
    },
  },
  replicability: {
    label: '복제 용이성',
